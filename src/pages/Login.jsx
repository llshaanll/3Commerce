...
const Login = () => {
  ...
  return (
    <div className='min-h-screen w-screen flex items-center justify-center font-mono relative overflow-hidden'>
      {/* Video Background with all necessary attributes */}
      <video
        ref={videoRef}
        className='absolute z-0 object-cover w-full h-full'
        src="/assets/loginBG.mp4"  // Changed path to absolute from root
        autoPlay
        loop
        muted
        playsInline
      ...
      {/* Login Form */}
      <div className='border-amber-50/40 border-2 flex flex-col items-center justify-center p-10 relative z-10 bg-white/20 backdrop-blur-sm group hover:scale-105 hover:shadow-xl/20 transition-all duration-300'>
        <h1 className='absolute top-1 font-mono font-bold text-xl'>Login with Mobile</h1>
